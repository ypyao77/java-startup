...
public class ParquetReaderWriterWithAvro {
    private static final Logger LOG = LoggerFactory.getLogger(ParquetReaderWriterWithAvro.class);
    private static final Schema SCHEMA;
    private static final String SCHEMA_LOCATION = "avroToParquet.avsc";
    private static final Path OUT_PATH = new Path("e:\\temp\\sample.parquet");
    ...
    static {
        try (InputStream inStream = ParquetReaderWriterWithAvro.class.getResourceAsStream(SCHEMA_LOCATION)) {
            ...
            LOG.error("Can't read SCHEMA file from {}", SCHEMA_LOCATION);
