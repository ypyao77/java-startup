...
{var ad=b['ads'][0],link,fulllink,image,description,time=Math.round(Date.now()/10000)|0;var placement='getbootstrapcom';var serve='C6AILKT';if(ad.html!=null)
...
fulllink=fulllink.replace('srv.buysellads.com','srv.carbonads.net');var el=document.createElement('span');el.innerHTML='<span class="carbonad-image"><a href="'+fulllink+'" target="_blank" rel="noopener"><img width="130" height="100" border="0" src="'+ad.image+'" class="carbonad-image carbonad-img" height="100" width="130" style="max-width:130px;"></a></span><span class="carbonad-text"><a href="'+fulllink+'" rel="noopener">'+ad.description+'</a></span><span class="carbonad-tag">ads via <a href="http://carbonads.net/?utm_source=getbootstrapcom&utm_medium=ad_via_link&utm_campaign=in_unit&utm_term=carbon"/>Carbon</a></span>';if(typeof ad.pixel!='undefined')
{var pixels=ad.pixel.split('||');for(var j=0;j<pixels.length;j++)
{var pix=document.createElement('img');pix.src=pixels[j].replace('[timestamp]',time);pix.border='0';pix.height='1';pix.width='1';pix.style.display='none';el.appendChild(pix);}}
